...
DLS2_DCS_TARGET_PLATFORM_$(BR2_PACKAGE_DLS2_DCS_TARGET_PLATFORM_TX48) = TX48
DLS2_DCS_TARGET_PLATFORM_$(BR2_PACKAGE_DLS2_DCS_TARGET_PLATFORM_FTT_TX) = FTT_TX

DLS2_DCS_CONF_OPT += -DTARGET_PLATFORM=$(DLS2_DCS_TARGET_PLATFORM_y) -DMAKO_RENDER=$(HOST_DIR)/usr/bin/mako-render -DSWIG_EXECUTABLE=$(HOST_DIR)/usr/bin/swig -DSWIG_DIR=$(HOST_DIR)/usr/share/swig/2.0.9 -DSURPC_PREFIX=$(STAGING_DIR)/usr 
